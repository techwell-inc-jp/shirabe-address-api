 ...
 * 住所 API 静的ページ共通レイアウト
 *
 * 暦 API(shirabe-calendar)の同名モジュールと同じスタイル・構造を維持し、
 * shirabe.dev 全体で見た目を揃える。フッターのリポジトリリンクのみ住所 API に差し替え。
 */
...
<header>
  <div class="container">
    ...
    <nav>
      ...
      <a href="https://github.com/techwell-inc-jp/shirabe-address-api" target="_blank" rel="noopener">GitHub</a>
    </nav>
  </div>
</header>`;
...
<link rel="alternate" type="application/yaml" title="OpenAPI 3.1 spec" href="https://shirabe.dev/api/v1/address/openapi.yaml">
${options.extraHead ?? ""}
${ldJson}
<style>${STYLES}</style>
</head>
